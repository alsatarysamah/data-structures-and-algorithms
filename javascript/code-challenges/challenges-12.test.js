...
Write a function named validateWord that uses a regular expression 
pattern to validate that word is between 5 and 10 characters long.
...
Write a function named hasNumber that uses a regular expression pattern to determine if 
a string has one or more letter followed by one or more digit.
...
Note: if you ever need to validate an email using a regex in practice, the Internet 
has the actual regex you should use. It's many many lines long.
------------------------------------------------------------------------------------------------ */
