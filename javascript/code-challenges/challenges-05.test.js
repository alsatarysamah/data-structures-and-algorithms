...
const addPurchases = (arr) => {
  // Solution code here...
  let total =arr.reduce(totalPrice,0)
  function totalPrice(totalPrice,price)
  {
    return totalPrice+price.purchasePrice;
  }
  return total;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let name=arr.reduce(names,0);
  function names(tot,current,index,arr)
  {
    arr[index]=current.name;
  return arr;
  }
  return name;
...
const reversedString = (str) => {
  // Solution code here...
  let arr = [];
  let rev=str.split("").reduce(reversing,"");
  function reversing(tot,current,index)
  {
    console.log(current)
arr.push(current);
return arr;
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let sum =arr.reduce(counting,0);
  function counting(tot,current,index,arr)
  {if (current.children !=null)
    return tot+current.children.length;
    else return tot;
  }
  return sum;
};
